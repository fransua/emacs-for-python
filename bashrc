...
if [ `whoami` = 'root' ]; then
    export PS1='${debian_chroot:+($debian_chroot)}\[\033[00;32m\]\H\[\033[00m\] \[\033[01;34m\]\w/\[\033[31m\]\$\[\033[00m\] '
else
    export PS1='${debian_chroot:+($debian_chroot)}\[\033[00;32m\]\H\[\033[00m\] \[\033[01;34m\]\w/\[\033[00m\]\$ '
fi
